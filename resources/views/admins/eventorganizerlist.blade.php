                ...
                <table class="table table-hover table-bordered mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.eventorganizer.edit', $organizer->id) }}" >
                                    <button type="button" class="btn btn-warning">Edit</button>
                                </a>
                                <form action="{{ route('admin.eventorganizer.delete', $organizer->id) }}" method="POST">
                                    @csrf
                                    @method('post')
                                    <button type="submit" class="btn btn-danger" title="Delete" onclick="return confirm('Are you sure you want to remove this organizer?')">
                                        Delete
                                    </button>
                                </form>
                            </td>
